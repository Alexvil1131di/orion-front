...
const UserCard = ({ email, name, lastname, addresses }: UserCardProps) => {
    return (
        <div className="max-w-sm h-fit rounded-[25px] overflow-hidden shadow-lg bg-white p-6">
            ...
            <div className='flex text-white gap-4 mt-4'>
                <button className=' bg-red-500 w-full rounded-[25px]'>Delete</button>
                <button className=' bg-blue-400 w-full rounded-[25px] '>Edit</button>
            </div>
        </div>
    );
};
